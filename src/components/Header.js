import { faChartBar, faChartPie, faUser, faUserAlt, faUsers } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import React, { useEffect, useState } from 'react'
import { Link } from 'react-router-dom'
import { Card, CardBody, CardTitle, Col, Dropdown, DropdownItem, DropdownMenu, DropdownToggle, Media, Nav, Row, UncontrolledDropdown } from 'reactstrap'
...
const Header = () => {
    ...
    useEffect(() => {
         fetch(`${BaseAPI}/api/dashboard`, {method: 'GET',
            headers:authHeader()
          }).then((listOfCommon) => {
                                ...
                                <UncontrolledDropdown nav>
                                        ...
                                        <Media className="align-items-center">
                                            <Media className="ml-2 d-none text-end d-lg-block">
                                                {<span className="mb-0 text-sm text-white">
                                                    <FontAwesomeIcon icon={faUserAlt} className='fs-5 rounded-5 p-2 border' /><br/>
                                    ...
                                    <DropdownMenu className="dropdown-menu-arrow" right>
                                        ...
                                        <DropdownItem href="#">
                                            ...
                                            <Link to='/' ><span className="text-black sidebar-text">Logout</span></Link>
                                        </DropdownItem>
                                    </DropdownMenu>
                                ...
                                <CardBody>
                                    <Row>
                                        <Col className='p-0'>
                                            ...
                                            <span className="h6 font-weight-bold mb-0">
                                                {/* XXX,XXX */}
                                                {commonStat.FarmMachineHistoryStat}
                                            </span>
                                        </Col>
                                        <Col className="col-sm-5 text-center vh-50">
