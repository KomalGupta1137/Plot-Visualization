...
//       // fetch(`http://localhost:8081/api/farmer`, {
//       method: "POST",
//       headers: authHeader(),
//       // headers: {
...
//                             <Col className="m-2">
//                               <Row>
//                                 <Col><h4><b>Farmer</b></h4></Col>
//                                 <Col xs='8'>&nbsp;</Col>
//                                 <Col><Button color="success" type="submit">Submit</Button></Col>
//                               </Row>
//                             </Col>
//                             <Col xs="6">
...
//                                     >
//                                       <option selected value="">Select Owner Type</option>
//                                       <option >Owner</option>
//                                       <option >Lease</option>
//                                     </Input>
//                                   </Col>
...
//                                     >
//                                       <option selected value="">Select ClusterId</option>
...
//                                     >
//                                       <option selected value="">Select Farmer Season</option>
...
//                                       type="select"
//                                       required
//                                       onChange={(e) => handleCropType(e.target.value)}
//                                     >
//                                       <option selected value="">Select Crop Type</option>
//                                       {cropTypeList.map((cropLists, index) => {
//                                         return (
//                                           <option key={index} value={cropLists.id}>
//                                             {cropLists.name}
//                                           </option>
//                                         );
//                                       })}
...
//                                       type="select"
//                                       required
//                                       onChange={(e) => setCropSubType(e.target.value)}
//                                     >
//                                       <option selected value="">Select Variety</option>
